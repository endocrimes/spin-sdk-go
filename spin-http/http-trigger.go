...
type FermyonSpinLlmInferencingModel = string
type FermyonSpinLlmInferencingParams struct {
  MaxTokens uint32
...
type FermyonSpinLlmErrorKind int

const (
FermyonSpinLlmErrorKindModelNotSupported FermyonSpinLlmErrorKind = iota
FermyonSpinLlmErrorKindRuntimeError
FermyonSpinLlmErrorKindInvalidInput
)

type FermyonSpinLlmError struct {
  kind FermyonSpinLlmErrorKind
  val any
}

func (n FermyonSpinLlmError) Kind() FermyonSpinLlmErrorKind {
  return n.kind
}

func FermyonSpinLlmErrorModelNotSupported() FermyonSpinLlmError{
  return FermyonSpinLlmError{kind: FermyonSpinLlmErrorKindModelNotSupported}
}

func FermyonSpinLlmErrorRuntimeError(v string) FermyonSpinLlmError{
  return FermyonSpinLlmError{kind: FermyonSpinLlmErrorKindRuntimeError, val: v}
}

func (n FermyonSpinLlmError) GetRuntimeError() string{
  if g, w := n.Kind(), FermyonSpinLlmErrorKindRuntimeError; g != w {
    panic(fmt.Sprintf("Attr kind is %v, not %v", g, w))
  }
  return n.val.(string)
}

func (n *FermyonSpinLlmError) SetRuntimeError(v string) {
  n.val = v
  n.kind = FermyonSpinLlmErrorKindRuntimeError
}

func FermyonSpinLlmErrorInvalidInput(v string) FermyonSpinLlmError{
  return FermyonSpinLlmError{kind: FermyonSpinLlmErrorKindInvalidInput, val: v}
}

func (n FermyonSpinLlmError) GetInvalidInput() string{
  if g, w := n.Kind(), FermyonSpinLlmErrorKindInvalidInput; g != w {
    panic(fmt.Sprintf("Attr kind is %v, not %v", g, w))
  }
  return n.val.(string)
}

func (n *FermyonSpinLlmError) SetInvalidInput(v string) {
  n.val = v
  n.kind = FermyonSpinLlmErrorKindInvalidInput
}

type FermyonSpinLlmInferencingUsage struct {
  PromptTokenCount uint32
  GeneratedTokenCount uint32
}

type FermyonSpinLlmInferencingResult struct {
  Text string
  Usage FermyonSpinLlmInferencingUsage
}

type FermyonSpinLlmEmbeddingModel = string
type FermyonSpinLlmEmbeddingsUsage struct {
  PromptTokenCount uint32
}

type FermyonSpinLlmEmbeddingsResult struct {
  Embeddings [][]float32
  Usage FermyonSpinLlmEmbeddingsUsage
}
...
func FermyonSpinConfigGetConfig(key string) Result[string, FermyonSpinConfigError] {
  ...
  var ret C.http_trigger_result_string_fermyon_spin_config_error_t
...
func FermyonSpinPostgresQuery(address string, statement string, params []FermyonSpinRdbmsTypesParameterValue) Result[FermyonSpinRdbmsTypesRowSet, FermyonSpinPostgresPgError] {
  ...
  var lower_params C.http_trigger_list_fermyon_spin_postgres_parameter_value_t
  if len(params) == 0 {
  ...
  defer C.http_trigger_list_fermyon_spin_postgres_parameter_value_free(&lower_params)
  var ret C.http_trigger_result_fermyon_spin_postgres_row_set_fermyon_spin_postgres_pg_error_t
...
func FermyonSpinPostgresExecute(address string, statement string, params []FermyonSpinRdbmsTypesParameterValue) Result[uint64, FermyonSpinPostgresPgError] {
  ...
  defer C.http_trigger_list_fermyon_spin_postgres_parameter_value_free(&lower_params)
  var ret C.http_trigger_result_u64_fermyon_spin_postgres_pg_error_t
...
func FermyonSpinMysqlQuery(address string, statement string, params []FermyonSpinRdbmsTypesParameterValue) Result[FermyonSpinRdbmsTypesRowSet, FermyonSpinMysqlMysqlError] {
  ...
  lower_statement.len = C.size_t(len(statement))
  defer C.http_trigger_string_free(&lower_statement)
  var lower_params C.http_trigger_list_fermyon_spin_mysql_parameter_value_t
  if len(params) == 0 {
    lower_params.ptr = nil
    lower_params.len = 0
  } else {
  ...
  defer C.http_trigger_list_fermyon_spin_mysql_parameter_value_free(&lower_params)
  var ret C.http_trigger_result_fermyon_spin_mysql_row_set_fermyon_spin_mysql_mysql_error_t
...
func FermyonSpinMysqlExecute(address string, statement string, params []FermyonSpinRdbmsTypesParameterValue) Result[struct{}, FermyonSpinMysqlMysqlError] {
  ...
  defer C.http_trigger_list_fermyon_spin_mysql_parameter_value_free(&lower_params)
  var ret C.http_trigger_result_void_fermyon_spin_mysql_mysql_error_t
...
func FermyonSpinSqliteOpen(database string) Result[uint32, FermyonSpinSqliteError] {
  ...
  var ret C.http_trigger_result_fermyon_spin_sqlite_connection_fermyon_spin_sqlite_error_t
...
func FermyonSpinSqliteExecute(conn uint32, statement string, parameters []FermyonSpinSqliteValue) Result[FermyonSpinSqliteQueryResult, FermyonSpinSqliteError] {
  ...
  lower_statement.len = C.size_t(len(statement))
  defer C.http_trigger_string_free(&lower_statement)
  var lower_parameters C.http_trigger_list_fermyon_spin_sqlite_value_t
  if len(parameters) == 0 {
  ...
  defer C.http_trigger_list_fermyon_spin_sqlite_value_free(&lower_parameters)
  var ret C.http_trigger_result_fermyon_spin_sqlite_query_result_fermyon_spin_sqlite_error_t
...
func FermyonSpinRedisPublish(address string, channel string, payload []uint8) Result[struct{}, FermyonSpinRedisTypesError] {
  ...
  var ret C.http_trigger_result_void_fermyon_spin_redis_error_t
...
func FermyonSpinRedisGet(address string, key string) Result[[]uint8, FermyonSpinRedisTypesError] {
  ...
  lower_key.len = C.size_t(len(key))
  defer C.http_trigger_string_free(&lower_key)
  var ret C.http_trigger_result_fermyon_spin_redis_payload_fermyon_spin_redis_error_t
...
func FermyonSpinRedisIncr(address string, key string) Result[int64, FermyonSpinRedisTypesError] {
  ...
  lower_key.len = C.size_t(len(key))
  defer C.http_trigger_string_free(&lower_key)
  var ret C.http_trigger_result_s64_fermyon_spin_redis_error_t
...
func FermyonSpinRedisSmembers(address string, key string) Result[[]string, FermyonSpinRedisTypesError] {
  ...
  lower_key.len = C.size_t(len(key))
  defer C.http_trigger_string_free(&lower_key)
  var ret C.http_trigger_result_list_string_fermyon_spin_redis_error_t
...
func FermyonSpinRedisExecute(address string, command string, arguments []FermyonSpinRedisTypesRedisParameter) Result[[]FermyonSpinRedisTypesRedisResult, FermyonSpinRedisTypesError] {
  ...
  var lower_arguments C.http_trigger_list_fermyon_spin_redis_redis_parameter_t
  if len(arguments) == 0 {
  ...
  defer C.http_trigger_list_fermyon_spin_redis_redis_parameter_free(&lower_arguments)
  var ret C.http_trigger_result_list_fermyon_spin_redis_redis_result_fermyon_spin_redis_error_t
  ...
  if ret.is_err {
    ...
    lift_ret_ptr := *(*C.http_trigger_list_fermyon_spin_redis_redis_result_t)(unsafe.Pointer(&ret.val))
    ...
    if lift_ret_ptr.len > 0 {
      for lift_ret_val_i := 0; lift_ret_val_i < int(lift_ret_ptr.len); lift_ret_val_i++ {
        ...
        if lift_ret_val_ptr.tag == 1 {
          ...
          list_lift_ret_val_val_val = C.GoStringN((*C.char)(unsafe.Pointer(list_lift_ret_val_val_ptr.ptr)), C.int(list_lift_ret_val_val_ptr.len))
...
func FermyonSpinKeyValueOpen(name string) Result[uint32, FermyonSpinKeyValueError] {
  ...
  var ret C.http_trigger_result_fermyon_spin_key_value_store_fermyon_spin_key_value_error_t
...
func FermyonSpinKeyValueGet(store uint32, key string) Result[[]uint8, FermyonSpinKeyValueError] {
  ...
  lower_key.len = C.size_t(len(key))
  defer C.http_trigger_string_free(&lower_key)
  var ret C.http_trigger_result_list_u8_fermyon_spin_key_value_error_t
...
func FermyonSpinKeyValueSet(store uint32, key string, value []uint8) Result[struct{}, FermyonSpinKeyValueError] {
  ...
  var ret C.http_trigger_result_void_fermyon_spin_key_value_error_t
...
func FermyonSpinKeyValueExists(store uint32, key string) Result[bool, FermyonSpinKeyValueError] {
  ...
  lower_key.len = C.size_t(len(key))
  defer C.http_trigger_string_free(&lower_key)
  var ret C.http_trigger_result_bool_fermyon_spin_key_value_error_t
...
func FermyonSpinKeyValueGetKeys(store uint32) Result[[]string, FermyonSpinKeyValueError] {
  ...
  lower_store_val := C.uint32_t(store)
  lower_store = lower_store_val
  var ret C.http_trigger_result_list_string_fermyon_spin_key_value_error_t
...
func FermyonSpinHttpSendRequest(req FermyonSpinHttpTypesRequest) Result[FermyonSpinHttpTypesResponse, FermyonSpinHttpTypesHttpError] {
  ...
  // use unsafe.Pointer to avoid copy
  lower_req_val_uri_val.ptr = (*uint8)(unsafe.Pointer(C.CString(req.Uri)))
  ...
  if len(req.Headers) == 0 {
    ...
    for lower_req_val_headers_i := range req.Headers {
      ...
      // use unsafe.Pointer to avoid copy
      lower_req_val_headers_ptr_value_f0.ptr = (*uint8)(unsafe.Pointer(C.CString(req.Headers[lower_req_val_headers_i].F0)))
      ...
      // use unsafe.Pointer to avoid copy
      lower_req_val_headers_ptr_value_f1.ptr = (*uint8)(unsafe.Pointer(C.CString(req.Headers[lower_req_val_headers_i].F1)))
  ...
  if len(req.Params) == 0 {
    ...
    for lower_req_val_params_i := range req.Params {
      ...
      // use unsafe.Pointer to avoid copy
      lower_req_val_params_ptr_value_f0.ptr = (*uint8)(unsafe.Pointer(C.CString(req.Params[lower_req_val_params_i].F0)))
      ...
      // use unsafe.Pointer to avoid copy
      lower_req_val_params_ptr_value_f1.ptr = (*uint8)(unsafe.Pointer(C.CString(req.Params[lower_req_val_params_i].F1)))
  ...
  var lower_req_val_body C.http_trigger_option_fermyon_spin_http_types_body_t
  if req.Body.IsSome() {
  ...
  var ret C.http_trigger_result_fermyon_spin_http_response_fermyon_spin_http_http_error_t
    ...
    if lift_ret_ptr.headers.is_some {
      ...
      if lift_ret_ptr.headers.val.len > 0 {
        for lift_ret_val_val_Headers_val_i := 0; lift_ret_val_val_Headers_val_i < int(lift_ret_ptr.headers.val.len); lift_ret_val_val_Headers_val_i++ {
          ...
          list_lift_ret_val_val_Headers_val_F0 = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_val_Headers_val_ptr.f0.ptr)), C.int(lift_ret_val_val_Headers_val_ptr.f0.len))
          list_lift_ret_val_val_Headers_val.F0 = list_lift_ret_val_val_Headers_val_F0
          var list_lift_ret_val_val_Headers_val_F1 string
          list_lift_ret_val_val_Headers_val_F1 = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_val_Headers_val_ptr.f1.ptr)), C.int(lift_ret_val_val_Headers_val_ptr.f1.len))
...
// Import functions from fermyon:spin/llm
func FermyonSpinLlmInfer(model string, prompt string, params Option[FermyonSpinLlmInferencingParams]) Result[FermyonSpinLlmInferencingResult, FermyonSpinLlmError] {
  ...
  defer C.fermyon_spin_llm_inferencing_model_free(&lower_model)
  ...
  defer C.http_trigger_string_free(&lower_prompt)
  var lower_params C.http_trigger_option_fermyon_spin_llm_inferencing_params_t
  if params.IsSome() {
    var lower_params_val C.fermyon_spin_llm_inferencing_params_t
  ...
  var ret C.http_trigger_result_fermyon_spin_llm_inferencing_result_fermyon_spin_llm_error_t
  C.fermyon_spin_llm_infer(&lower_model, &lower_prompt, &lower_params, &ret)
  var lift_ret Result[FermyonSpinLlmInferencingResult, FermyonSpinLlmError]
  if ret.is_err {
    lift_ret_ptr := *(*C.fermyon_spin_llm_error_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val FermyonSpinLlmError
    if lift_ret_ptr.tag == 0 {
      lift_ret_val = FermyonSpinLlmErrorModelNotSupported()
    }
    if lift_ret_ptr.tag == 1 {
      lift_ret_val_ptr := *(*C.http_trigger_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val string
      lift_ret_val_val = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_ptr.ptr)), C.int(lift_ret_val_ptr.len))
      lift_ret_val = FermyonSpinLlmErrorRuntimeError(lift_ret_val_val)
    }
    if lift_ret_ptr.tag == 2 {
      lift_ret_val_ptr := *(*C.http_trigger_string_t)(unsafe.Pointer(&lift_ret_ptr.val))
      var lift_ret_val_val string
      lift_ret_val_val = C.GoStringN((*C.char)(unsafe.Pointer(lift_ret_val_ptr.ptr)), C.int(lift_ret_val_ptr.len))
      lift_ret_val = FermyonSpinLlmErrorInvalidInput(lift_ret_val_val)
    }
    lift_ret.SetErr(lift_ret_val)
  } else {
    lift_ret_ptr := *(*C.fermyon_spin_llm_inferencing_result_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val FermyonSpinLlmInferencingResult
    ...
    var lift_ret_val_Usage FermyonSpinLlmInferencingUsage
...
func FermyonSpinLlmGenerateEmbeddings(model string, text []string) Result[FermyonSpinLlmEmbeddingsResult, FermyonSpinLlmError] {
  var lower_model C.http_trigger_string_t
  var lower_model_val C.http_trigger_string_t
  ...
  lower_model_val.len = C.size_t(len(model))
  lower_model = lower_model_val
  defer C.fermyon_spin_llm_embedding_model_free(&lower_model)
  ...
  defer C.http_trigger_list_string_free(&lower_text)
  var ret C.http_trigger_result_fermyon_spin_llm_embeddings_result_fermyon_spin_llm_error_t
  C.fermyon_spin_llm_generate_embeddings(&lower_model, &lower_text, &ret)
  var lift_ret Result[FermyonSpinLlmEmbeddingsResult, FermyonSpinLlmError]
  if ret.is_err {
    lift_ret_ptr := *(*C.fermyon_spin_llm_error_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val FermyonSpinLlmError
    if lift_ret_ptr.tag == 0 {
    ...
    lift_ret_ptr := *(*C.fermyon_spin_llm_embeddings_result_t)(unsafe.Pointer(&ret.val))
    var lift_ret_val FermyonSpinLlmEmbeddingsResult
    ...
    var lift_ret_val_Usage FermyonSpinLlmEmbeddingsUsage
    var lift_ret_val_Usage_PromptTokenCount uint32
    lift_ret_val_Usage_PromptTokenCount = uint32(lift_ret_ptr.usage.prompt_token_count)
    lift_ret_val_Usage.PromptTokenCount = lift_ret_val_Usage_PromptTokenCount
    lift_ret_val.Usage = lift_ret_val_Usage
...
func ExportsFermyonSpinInboundHttpHandleRequest(req *C.fermyon_spin_inbound_http_request_t, ret *C.fermyon_spin_inbound_http_response_t) {
  ...
  lift_req_val_Uri_val = C.GoStringN((*C.char)(unsafe.Pointer(req.uri.ptr)), C.int(req.uri.len))
  ...
  if req.headers.len > 0 {
    for lift_req_val_Headers_i := 0; lift_req_val_Headers_i < int(req.headers.len); lift_req_val_Headers_i++ {
      ...
      list_lift_req_val_Headers_F0 = C.GoStringN((*C.char)(unsafe.Pointer(lift_req_val_Headers_ptr.f0.ptr)), C.int(lift_req_val_Headers_ptr.f0.len))
      list_lift_req_val_Headers.F0 = list_lift_req_val_Headers_F0
      var list_lift_req_val_Headers_F1 string
      list_lift_req_val_Headers_F1 = C.GoStringN((*C.char)(unsafe.Pointer(lift_req_val_Headers_ptr.f1.ptr)), C.int(lift_req_val_Headers_ptr.f1.len))
  ...
  if req.params.len > 0 {
    for lift_req_val_Params_i := 0; lift_req_val_Params_i < int(req.params.len); lift_req_val_Params_i++ {
      ...
      list_lift_req_val_Params_F0 = C.GoStringN((*C.char)(unsafe.Pointer(lift_req_val_Params_ptr.f0.ptr)), C.int(lift_req_val_Params_ptr.f0.len))
      list_lift_req_val_Params.F0 = list_lift_req_val_Params_F0
      var list_lift_req_val_Params_F1 string
      list_lift_req_val_Params_F1 = C.GoStringN((*C.char)(unsafe.Pointer(lift_req_val_Params_ptr.f1.ptr)), C.int(lift_req_val_Params_ptr.f1.len))
  ...
  var lower_result_val_headers C.http_trigger_option_fermyon_spin_http_types_headers_t
  if result.Headers.IsSome() {
    ...
    if len(result.Headers.Unwrap()) == 0 {
      ...
      for lower_result_val_headers_val_i := range result.Headers.Unwrap() {
        ...
        // use unsafe.Pointer to avoid copy
        lower_result_val_headers_val_ptr_value_f0.ptr = (*uint8)(unsafe.Pointer(C.CString(result.Headers.Unwrap()[lower_result_val_headers_val_i].F0)))
        ...
        // use unsafe.Pointer to avoid copy
        lower_result_val_headers_val_ptr_value_f1.ptr = (*uint8)(unsafe.Pointer(C.CString(result.Headers.Unwrap()[lower_result_val_headers_val_i].F1)))
  ...
  var lower_result_val_body C.http_trigger_option_fermyon_spin_http_types_body_t
